...
inline std::vector<std::string> transform_tags(const std::string& mstr, const std::string& vstr) {
...
inline void set_part_of_address_from_label(AtomAddress& a, const Model& model,
...
inline DiffractionInfo* find_diffrn(Metadata& meta, const std::string& diffrn_id) {
