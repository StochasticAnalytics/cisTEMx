...
for i in 0 1 2 3 4; do 
    ...
    case $i in
        ...
        2)
            echo "R is 7.5"
            res_val='(8 6 4 3 0 2.8)'
            loc_ang='(4 3 2 1 1 0.5)'
            ;;
        3)
            echo "R is 10"
            res_val='(10 8 6 4 3 0 2.8)'
            loc_ang='(5 4 3 2 1 1 0.5)'
            ;;
        4)
            echo "R is 12.5"
            res_val='(12 8 6 4 3 0 2.8)'
            loc_ang='(6 4 3 2 1 1 0.5)'
            ;;
        *)
    ...
    awk -v I="$R" -v A="$loc_ang" -v R="$res_val"  '{if(/^output_dir/) print "output_dir=sweep_"I ; else print $0}'  params.sh > tmp 
