...
def main():
    try:
        ...
        # Check if --run-analysis is being used appropriately
        # This flag only makes sense in the test_template_reproducibility.py script
        script_name = os.path.basename(__file__)
        if args.run_analysis and script_name != 'test_template_reproducibility.py':
