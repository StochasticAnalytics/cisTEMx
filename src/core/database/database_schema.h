...
std::vector<TableData> static_tables{
        ...
        {"TEMPLATE_MATCH_LIST", "plrliiliitrrrrrrrrrr", {"TEMPLATE_MATCH_ID", "DATETIME_OF_RUN", "ELAPSED_TIME_SECONDS", "SEARCH_ID", "SEARCH_TYPE_CODE", "PARENT_SEARCH_ID", "IMAGE_ASSET_ID", "REFERENCE_VOLUME_ASSET_ID", "IS_ACTIVE", "OUTPUT_FILENAME_BASE", "PIXEL_SIZE", "VOLTAGE", "SPHERICAL_ABERRATION", "AMPLITUDE_CONTRAST", "DEFOCUS1", "DEFOCUS2", "DEFOCUS_ANGLE", "PHASE_SHIFT", "FUTURE_FLOAT_1", "FUTURE_FLOAT_2"}},
