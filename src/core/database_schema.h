...
std::vector<TableData> static_tables{
        {"MASTER_SETTINGS", "pttiritt", {"NUMBER", "PROJECT_DIRECTORY", "PROJECT_NAME", "CURRENT_VERSION", "TOTAL_CPU_HOURS", "TOTAL_JOBS_RUN", "CISTEM_VERSION_TEXT", "CURRENT_WORKFLOW"}},
        ...
        //   - TEMPLATE_MATCH_LIST.TEMPLATE_MATCH_JOB_ID: Actually identifies a complete template matching search/run
