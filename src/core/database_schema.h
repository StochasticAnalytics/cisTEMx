#ifndef _SRC_CORE_DATABASE_SCHEMA_H_
#define _SRC_CORE_DATABASE_SCHEMA_H_
...
std::vector<TableData> dynamic_tables{
        ...
        // For now, we extend the REFINEMENT_PACKAGE_CONTAINED_PARTICLES_ table as the multiviewdata is experimental and low usage.
        {"REFINEMENT_PACKAGE_CONTAINED_PARTICLES_MULTI_VIEW_", "pirr", {"POSITION_IN_STACK", "PARTICLE_GROUP", "PRE_EXPOSURE", "TOTAL_EXPOSURE"}},
...
#endif // _SRC_CORE_DATABASE_SCHEMA_H_
