...
std::vector<TableData> static_tables{
        ...
        {"TEMPLATE_MATCH_QUEUE", "pttiliiitrrrrrrrrrrrrrrrrrrrrrrit", {"QUEUE_ID", "JOB_NAME", "QUEUE_STATUS", "QUEUE_POSITION", "DATETIME_QUEUED", "IMAGE_GROUP_ID", "REFERENCE_VOLUME_ASSET_ID", "USE_GPU", "USE_FAST_FFT", "SYMMETRY", "PIXEL_SIZE", "VOLTAGE", "SPHERICAL_ABERRATION", "AMPLITUDE_CONTRAST", "DEFOCUS1", "DEFOCUS2", "DEFOCUS_ANGLE", "PHASE_SHIFT", "LOW_RESOLUTION_LIMIT", "HIGH_RESOLUTION_LIMIT", "OUT_OF_PLANE_ANGULAR_STEP", "IN_PLANE_ANGULAR_STEP", "DEFOCUS_SEARCH_RANGE", "DEFOCUS_STEP", "PIXEL_SIZE_SEARCH_RANGE", "PIXEL_SIZE_STEP", "REFINEMENT_THRESHOLD", "REF_BOX_SIZE_IN_ANGSTROMS", "MASK_RADIUS", "MIN_PEAK_RADIUS", "XY_CHANGE_THRESHOLD", "EXCLUDE_ABOVE_XY_THRESHOLD", "CUSTOM_CLI_ARGS"}}};
