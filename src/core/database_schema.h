...
std::vector<TableData> static_tables{
        ...
        {"TEMPLATE_MATCH_LIST", "pllliiliitrrrrrrrrrr", {"TEMPLATE_MATCH_ID", "DATETIME_OF_RUN", "ELAPSED_TIME_SECONDS", "SEARCH_ID", "SEARCH_TYPE_CODE", "PARENT_SEARCH_ID", "IMAGE_ASSET_ID", "REFERENCE_VOLUME_ASSET_ID", "IS_ACTIVE", "OUTPUT_FILENAME_BASE", "PIXEL_SIZE", "VOLTAGE", "SPHERICAL_ABERRATION", "AMPLITUDE_CONTRAST", "DEFOCUS1", "DEFOCUS2", "DEFOCUS_ANGLE", "PHASE_SHIFT", "FUTURE_FLOAT_1", "FUTURE_FLOAT_2"}},
        {"TEMPLATE_MATCH_QUEUE", "ptllliiiiitrrrrrrrrrrrrritiirrtt", {"QUEUE_ID", "SEARCH_NAME", "SEARCH_ID", "QUEUE_POSITION", "DATETIME_QUEUED", "IMAGE_GROUP_ID", "REFERENCE_VOLUME_ASSET_ID", "RUN_PROFILE_ID", "USE_GPU", "USE_FAST_FFT", "SYMMETRY", "LOW_RESOLUTION_LIMIT", "HIGH_RESOLUTION_LIMIT", "OUT_OF_PLANE_ANGULAR_STEP", "IN_PLANE_ANGULAR_STEP", "DEFOCUS_SEARCH_RANGE", "DEFOCUS_STEP", "PIXEL_SIZE_SEARCH_RANGE", "PIXEL_SIZE_STEP", "REFINEMENT_THRESHOLD", "REF_BOX_SIZE_IN_ANGSTROMS", "MASK_RADIUS", "MIN_PEAK_RADIUS", "XY_CHANGE_THRESHOLD", "EXCLUDE_ABOVE_XY_THRESHOLD", "CUSTOM_CLI_ARGS", "FUTURE_INT_1", "FUTURE_INT_2", "FUTURE_FLOAT_1", "FUTURE_FLOAT_2", "FUTURE_TEXT_1", "FUTURE_TEXT_2"}},
        // Import defaults tables: These are static (single-instance, no numeric suffix) but don't always exist -
        // they're created on first use when user imports movies/images to store default parameter values
