...
template <>
void ElectronDose::CalculateDoseFilterAs1DArray<Image, float>(Image* ref_image, float* filter_array, float dose_start, float dose_finish, int n_images, bool restore_power) {
