...
class Image {
  ...
  public:
    ...
    void FindPeakWithIntegerCoordinatesForManyPeaks(std::vector<Peak>& peak_list, const float peak_threshold, const float peak_threshold_scale, const float exclusion_radius, const int wanted_min_distance_from_edges);
