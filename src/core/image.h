...
class Image {
  ...
  public:
    ...
    void FindPeakWithIntegerCoordinatesForManyPeaks(std::vector<Peak>& peak_list, float peak_threshold, float peak_threshold_scale, float exclusion_radius, int wanted_min_distance_from_edges);
