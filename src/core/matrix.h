...
class RotationMatrix {
  ...
  public:
    ...
    inline void RotateCoords(const float input_x_coord, const float input_y_coord, const float input_z_coord, float& output_x_coord, float& output_y_coord, float& output_z_coord) {
