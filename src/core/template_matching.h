...
class TemplateMatchJobResults {
  public:
    ...
    int      job_type;
    long     input_job_id;
    long     job_id; // This is the search_id
    long     template_match_id; // Unique ID for this specific result
    ...
    // Example: "/path/to/project/Assets/TemplateMatching/FoilHole_24015405_Data_24016401_24016403_20200225_0014_Fractions.mrc"
    // Individual filenames generated by appending: "_<type>_<template_match_id>_<job_id>.mrc"
