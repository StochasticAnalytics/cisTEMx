...
class AssetObjectPanel : public AssetObjectPanelParent {
  ...
  public:
    ...
    AssetObjectPanel(wxWindow* parent);
    ~AssetObjectPanel( );
    ...
    const char* Type( ) const { return "AssetObjectPanel"; };
};
...
class GroupDropTarget : public wxDropTarget {
  ...
  private:
    ...
    AssetObjectPanel* my_panel;

  public:
    GroupDropTarget(wxListCtrl* owner, AssetObjectPanel* asset_panel);
