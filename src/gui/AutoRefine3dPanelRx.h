#ifndef __src_gui_AutoRefine3DPanelRx_h__
#define __src_gui_AutoRefine3DPanelRx_h__
...
class AutoRefine3DPanelRx : public AutoRefine3DPanelParent {

    friend class AutoRefinementManager<AutoRefine3DPanelRx>;
  ...
  protected:
    ...
    AutoRefinementManager<AutoRefine3DPanelRx> my_refinement_manager;
  ...
  public:
    ...
    AutoRefine3DPanelRx(wxWindow* parent);
