...
ImportAtomicCoordinatesDialog::ImportAtomicCoordinatesDialog(wxWindow* parent)
    : ImportAtomicCoordinatesDialogParent(parent) {
    int list_height;
    int list_width;
...
void ImportAtomicCoordinatesDialog::AddFilesClick(wxCommandEvent& event) {
...
void ImportAtomicCoordinatesDialog::ClearClick(wxCommandEvent& event) {
    PathListCtrl->DeleteAllItems( );
    CheckImportButtonStatus( );
}

void ImportAtomicCoordinatesDialog::CancelClick(wxCommandEvent& event) {
    Destroy( );
}

void ImportAtomicCoordinatesDialog::AddDirectoryClick(wxCommandEvent& event) {
...
void ImportAtomicCoordinatesDialog::OnTextKeyPress(wxKeyEvent& event) {
...
void ImportAtomicCoordinatesDialog::TextChanged(wxCommandEvent& event) {
    CheckImportButtonStatus( );
}

void ImportAtomicCoordinatesDialog::CheckImportButtonStatus( ) {
...
void ImportAtomicCoordinatesDialog::ImportClick(wxCommandEvent& event) {
    //
