...
ImportImageDialog::ImportImageDialog(wxWindow* parent)
    : ImportImageDialogParent(parent) {
    int list_height;
    int list_width;
...
void ImportImageDialog::AddFilesClick(wxCommandEvent& event) {
...
void ImportImageDialog::ClearClick(wxCommandEvent& event) {
    PathListCtrl->DeleteAllItems( );
    CheckImportButtonStatus( );
}

void ImportImageDialog::CancelClick(wxCommandEvent& event) {
    Destroy( );
}

void ImportImageDialog::AddDirectoryClick(wxCommandEvent& event) {
...
void ImportImageDialog::OnTextKeyPress(wxKeyEvent& event) {
...
void ImportImageDialog::TextChanged(wxCommandEvent& event) {
    CheckImportButtonStatus( );
}

void ImportImageDialog::CheckImportButtonStatus( ) {
...
void ImportImageDialog::ImportClick(wxCommandEvent& event) {
