...
ImportMovieDialog::ImportMovieDialog(wxWindow* parent)
    : ImportMovieDialogParent(parent) {
    int list_height;
    int list_width;
...
void ImportMovieDialog::AddFilesClick(wxCommandEvent& event) {
...
void ImportMovieDialog::ClearClick(wxCommandEvent& event) {
...
void ImportMovieDialog::CancelClick(wxCommandEvent& event) {
    Destroy( );
}

void ImportMovieDialog::AddDirectoryClick(wxCommandEvent& event) {
...
void ImportMovieDialog::OnTextKeyPress(wxKeyEvent& event) {
...
void ImportMovieDialog::OnGainFilePickerChanged(wxFileDirPickerEvent& event) {
    CheckImportButtonStatus( );
}

void ImportMovieDialog::OnSkipFullIntegrityCheckCheckBox(wxCommandEvent& event) {
    CheckImportButtonStatus( );
}

void ImportMovieDialog::OnMoviesAreGainCorrectedCheckBox(wxCommandEvent& event) {
    GainFilePicker->Enable(ApplyGainImageCheckbox->IsChecked( ));
    DarkFilePicker->Enable(ApplyDarkImageCheckbox->IsChecked( ));
    CheckImportButtonStatus( );
}

void ImportMovieDialog::OnResampleMoviesCheckBox(wxCommandEvent& event) {
    DesiredPixelSizeStaticText->Enable(ResampleMoviesCheckBox->IsChecked( ));
    DesiredPixelSizeTextCtrl->Enable(ResampleMoviesCheckBox->IsChecked( ));
...
void ImportMovieDialog::OnCorrectMagDistortionCheckBox(wxCommandEvent& event) {
    DistortionAngleTextCtrl->Enable(CorrectMagDistortionCheckBox->IsChecked( ));
    MajorScaleTextCtrl->Enable(CorrectMagDistortionCheckBox->IsChecked( ));
    MinorScaleTextCtrl->Enable(CorrectMagDistortionCheckBox->IsChecked( ));
    DistortionAngleStaticText->Enable(CorrectMagDistortionCheckBox->IsChecked( ));
...
void ImportMovieDialog::ImportClick(wxCommandEvent& event) {
