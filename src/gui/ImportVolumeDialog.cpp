...
ImportVolumeDialog::ImportVolumeDialog(wxWindow* parent)
    : ImportVolumeDialogParent(parent) {
    int list_height;
    int list_width;
...
void ImportVolumeDialog::AddFilesClick(wxCommandEvent& event) {
...
void ImportVolumeDialog::ClearClick(wxCommandEvent& event) {
    PathListCtrl->DeleteAllItems( );
    CheckImportButtonStatus( );
}

void ImportVolumeDialog::CancelClick(wxCommandEvent& event) {
    Destroy( );
}

void ImportVolumeDialog::AddDirectoryClick(wxCommandEvent& event) {
...
void ImportVolumeDialog::OnTextKeyPress(wxKeyEvent& event) {
...
void ImportVolumeDialog::TextChanged(wxCommandEvent& event) {
    CheckImportButtonStatus( );
}

void ImportVolumeDialog::CheckImportButtonStatus( ) {
    ...
    if ( PixelSizeText->GetLineLength(0) == 0 )
        enable_import_box = false;
...
void ImportVolumeDialog::ImportClick(wxCommandEvent& event) {
