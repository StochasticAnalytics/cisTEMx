...
void MatchTemplateResultsPanel::FillResultsPanelAndDetails(int row, int column) {
    ...
    if ( current_result.search_type_code == cistem::job_type::template_match_full_search )
        ...
        JobTitleStaticText->SetLabel(wxString::Format("%s, Refinement of job #%li", current_result.job_name, current_result.parent_search_id));
    ...
    RefVolumeIDStaticText->SetLabel(wxString::Format("%li", current_result.reference_volume_asset_id));
