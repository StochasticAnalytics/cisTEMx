...
OverviewPanel::OverviewPanel(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style)
    : OverviewPanelParent(parent, id, pos, size, style) {
    SetWelcomeInfo( );
}
...
void OverviewPanel::OnInfoURL(wxTextUrlEvent& event) {
