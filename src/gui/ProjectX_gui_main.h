...
class MainFrame : public wxFrame {
  ...
  public:
    ...
    MainFrame(wxWindow* parent, wxWindowID id = wxID_OPEN, const wxString& title = wxT("cisTEMx"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(1366, 768), long style = wxDEFAULT_FRAME_STYLE | wxTAB_TRAVERSAL | wxWANTS_CHARS);
...
class AboutDialog : public wxDialog {
  ...
  public:
    ...
    AboutDialog(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("About cisTEMx"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE);
