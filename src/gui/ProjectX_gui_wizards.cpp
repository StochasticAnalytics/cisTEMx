...
ImportRefinementPackageWizardParent::ImportRefinementPackageWizardParent(wxWindow* parent, wxWindowID id, const wxString& title, const wxBitmap& bitmap, const wxPoint& pos, long style) {
    ...
    cisTEMRadioButton = new wxRadioButton(ImportTypePage, wxID_ANY, wxT("cisTEMx (Requires particle stack and STAR file)"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    BlackProteinRadioButton = new wxRadioButton(GetParametersPage, wxID_ANY, wxT("Black (cisTEMx Default)"), wxDefaultPosition, wxDefaultSize, 0);
