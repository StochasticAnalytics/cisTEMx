#ifndef _gui_RefineTemplateDevPanel_h_
#define _gui_RefineTemplateDevPanel_h_

class RefineTemplateDevPanel : public RefineTemplateDevPanelParent {
    long my_job_id;
  ...
  public:
    RefineTemplateDevPanel(wxWindow* parent);
    ...
    const char* Type( ) const { return "RefineTemplateDevPanel"; };
};
