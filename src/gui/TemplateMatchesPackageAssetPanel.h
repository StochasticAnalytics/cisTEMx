...
#ifndef __TemplateMatchesPackageAssetPanel__
#define __TemplateMatchesPackageAssetPanel__

class TemplateMatchesPackageAssetPanel : public TemplateMatchesPackageAssetPanelParent {
  public:
    bool is_dirty;
    ...
    TemplateMatchesPackageAssetPanel(wxWindow* parent);
    ArrayOfTemplateMatchesPackages all_template_matches_packages;
    ...
    void AddAsset(TemplateMatchesPackage* temaplte_matches_package);
...
#endif // __TemplateMatchesPackageAssetPanel__
