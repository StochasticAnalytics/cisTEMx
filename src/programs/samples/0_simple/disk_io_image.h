 ...
 *
 *      Goal:
 *      	The purpose of this recipe, is to demonstrate the different means of reading/writing images to disk using cisTEMx.
 *
 *      Scope:
 ...
 *
 *      Background:
 *      	The Image class in cisTEMx can be used to represent 1,2 or 3D images, in memory, with extensions to higher dimensions only available via arrays of Images (or pointers to them.)
 ...
 *      	primary types supported in cisTEMx: MRC, TIF(F), DM, EER. We predominantly use the MRC format, which is very similar to CCP4. There are class specializations of mrc_file and mrc_header.
 *
 *
 *
 *
